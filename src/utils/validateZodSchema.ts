// Credit: Blitz
// https://github.com/blitz-js/blitz/blob/9f52f36c189c197efc03ee967482d126ba9beabb/nextjs/packages/next/stdlib/zod-utils.ts
...
export function validateZodSchema(schema: any, parserType: 'sync' | 'async' = 'async') {
  if (parserType === 'sync') {
